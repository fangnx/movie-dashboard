...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsDashboardNominationPanelNominationPanelComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsDashboardResultPanelResultPanelComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_material_material_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _components_notification_notification_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/notification/notification.component */
    "./src/app/components/notification/notification.component.ts");
    /* harmony import */


    var _components_dashboard_result_panel_result_panel_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/dashboard/result-panel/result-panel.component */
    "./src/app/components/dashboard/result-panel/result-panel.component.ts");
    /* harmony import */


    var _components_dashboard_nomination_panel_nomination_panel_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/dashboard/nomination-panel/nomination-panel.component */
    "./src/app/components/dashboard/nomination-panel/nomination-panel.component.ts");
    /* harmony import */


    var _services_omdb_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./services/omdb.service */
    ...
    var _state_app_reducer__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./state/app.reducer */
    "./src/app/state/app.reducer.ts");
    /* harmony import */


    var _state_app_effects__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./state/app.effects */
    "./src/app/state/app.effects.ts");
    /* harmony import */


    var _services_notification_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["DashboardComponent"], _components_dashboard_result_panel_result_panel_component__WEBPACK_IMPORTED_MODULE_11__["ResultPanelComponent"], _components_dashboard_nomination_panel_nomination_panel_component__WEBPACK_IMPORTED_MODULE_12__["NominationPanelComponent"], _components_notification_notification_component__WEBPACK_IMPORTED_MODULE_10__["NotificationComponent"]],
      imports: [_ngrx_store__WEBPACK_IMPORTED_MODULE_14__["StoreModule"].forRoot({
        app: _state_app_reducer__WEBPACK_IMPORTED_MODULE_16__["appReducer"]
      }, {
        metaReducers: [_state_app_reducer__WEBPACK_IMPORTED_MODULE_16__["localStorageSyncReducer"]]
      }), _ngrx_effects__WEBPACK_IMPORTED_MODULE_15__["EffectsModule"].forRoot([_state_app_effects__WEBPACK_IMPORTED_MODULE_17__["AppEffects"]]), _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"], _components_material_material_module__WEBPACK_IMPORTED_MODULE_8__["MaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"]],
  ...
  function srcAppComponentsDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _state_app_selector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../state/app.selector */
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(store, route) {
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.movies$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectMovies"])(state);
          });
          this.numOfResults$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectNumOfResults"])(state);
          });
          this.page$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectPage"])(state);
          });
          this.nominatedMovies$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectNominatedMovies"])(state);
          });
          this.searchTerm$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectSearchTerm"])(state);
          });
          this.searchError$ = this.store.select(function (state) {
            return Object(_state_app_selector__WEBPACK_IMPORTED_MODULE_4__["selectSearchError"])(state);
          });
        }
      }, {
        key: "initNominations",
        value: function initNominations() {
          if (this.route.snapshot.queryParams && this.route.snapshot.queryParams.nominations) {
            var movieIds = this.route.snapshot.queryParams.nominations.split(",");
            this.store.dispatch(src_app_state_app_actions__WEBPACK_IMPORTED_MODULE_5__["populateNominations"]({
              movieIds: movieIds
            }));
          }
        }
        ...
        value: function handleEnterSearch(searchTerm) {
          this.store.dispatch(src_app_state_app_actions__WEBPACK_IMPORTED_MODULE_5__["searchForMovies"]({
            searchValue: searchTerm
          }));
        }
      }, {
        key: "handlecClearSearch",
        value: function handlecClearSearch() {
        ...
        value: function handleChangePage(page) {
          this.store.dispatch(src_app_state_app_actions__WEBPACK_IMPORTED_MODULE_5__["goToPage"]({
            page: page + 1
          }));
        }
      }, {
        key: "handleNominateMovie",
        value: function handleNominateMovie(movie) {
          this.store.dispatch(src_app_state_app_actions__WEBPACK_IMPORTED_MODULE_5__["selectMovie"]({
            movie: movie
          }));
        }
      }, {
        key: "handleRemoveNominatedMovie",
        value: function handleRemoveNominatedMovie(movieId) {
          this.store.dispatch(src_app_state_app_actions__WEBPACK_IMPORTED_MODULE_5__["unselectMovie"]({
            movieId: movieId
          }));
        }
      }]);
  ...
  /***/
  function srcAppComponentsDashboardNominationPanelNominationPanelComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsDashboardNominationPanelNominationPanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NominationPanelComponent", function () {
      return NominationPanelComponent;
    });
    /* harmony import */
    ...
    var _helpers_clipboard_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var NominationPanelComponent = /*#__PURE__*/function () {
      function NominationPanelComponent() {
        _classCallCheck(this, NominationPanelComponent);
      ...
      _createClass(NominationPanelComponent, [{
        key: "ngOnChanges",
        value: function ngOnChanges() {
          this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_toConsumableArray(this.nominatedMovies));
        }
      }, {
        key: "handleRemoveClick",
        value: function handleRemoveClick(movie) {
        ...
        key: "isMoviePosterValid",
        value: function isMoviePosterValid(movie) {
          return movie.Poster && movie.Poster !== "N/A";
        }
      }, {
        key: "getColumnDisplayName",
        value: function getColumnDisplayName(column) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NominationPanelComponent.prototype, "nominatedMovies", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], NominationPanelComponent.prototype, "removeNominatedMovie", void 0);
    NominationPanelComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "nomination-panel",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./nomination-panel.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/dashboard/nomination-panel/nomination-panel.component.html"))["default"],
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      animations: [Object(angular_animations__WEBPACK_IMPORTED_MODULE_4__["fadeInOnEnterAnimation"])()],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./nomination-panel.component.scss */
      "./src/app/components/dashboard/nomination-panel/nomination-panel.component.scss"))["default"]]
  ...
  /***/
  function srcAppComponentsDashboardResultPanelResultPanelComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsDashboardResultPanelResultPanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResultPanelComponent", function () {
      return ResultPanelComponent;
    });
    /* harmony import */
    ...
    var angular_animations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! angular-animations */
    "./node_modules/angular-animations/fesm2015/angular-animations.js");

    var ResultPanelComponent = /*#__PURE__*/function () {
      function ResultPanelComponent() {
        _classCallCheck(this, ResultPanelComponent);
      ...
      _createClass(ResultPanelComponent, [{
        key: "ngOnChanges",
        ...
        value: function ngAfterViewInit() {
          ...
          this.searchDebounceSubscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this.input.nativeElement, "keyup").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
        ...
        key: "handlePaginatorChange",
        value: function handlePaginatorChange(event) {
        ...
        key: "handleNominationClick",
        value: function handleNominationClick(movie) {
          this.nominateMovie.emit(movie);
        }
      }, {
        key: "canNominate",
        value: function canNominate(movie) {
          return this.nominatedMovies.length < 5 && !this.isMovieNominated(movie);
        }
      }, {
        key: "isMovieNominated",
        value: function isMovieNominated(movie) {
          return this.nominatedMovies && this.nominatedMovies.some(function (nominatedMovie) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "movies", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "total", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "page", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "nominatedMovies", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "searchTerm", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ResultPanelComponent.prototype, "searchError", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ResultPanelComponent.prototype, "enterSearch", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ResultPanelComponent.prototype, "clearSearch", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ResultPanelComponent.prototype, "nominateMovie", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], ResultPanelComponent.prototype, "changePage", void 0);
    ResultPanelComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "result-panel",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./result-panel.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/dashboard/result-panel/result-panel.component.html"))["default"],
      changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
      ...
      "./src/app/components/dashboard/result-panel/result-panel.component.scss"))["default"]]
  ...
  /***/
  function srcAppComponentsHelpersClipboardHelperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ClipboardHelper", function () {
    ...
    var ClipboardHelper = /*#__PURE__*/function () {
      function ClipboardHelper() {
        _classCallCheck(this, ClipboardHelper);
      }

      _createClass(ClipboardHelper, null, [{
        key: "copyToClipboard",
  ...
  /***/
  function srcAppComponentsHelpersUriHelperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UriHelper", function () {
      return UriHelper;
    });
    /* harmony import */
    ...
    var UriHelper = /*#__PURE__*/function () {
      function UriHelper() {
        _classCallCheck(this, UriHelper);
      }

      _createClass(UriHelper, null, [{
        key: "generateParamsFromIds",
        value: function generateParamsFromIds(ids) {
  ...
  /***/
  function srcAppComponentsMaterialMaterialModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    MaterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["NgModule"])({
      exports: [_angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_1__["A11yModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_4__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_5__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_6__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_2__["DragDropModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatAutocompleteModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatBadgeModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatBottomSheetModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatButtonToggleModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatCardModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatCheckboxModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatChipsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatStepperModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatDatepickerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatDialogModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatDividerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatExpansionModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatGridListModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatIconModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatListModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatMenuModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatNativeDateModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatPaginatorModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatProgressBarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatProgressSpinnerModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatRadioModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatRippleModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSelectModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSidenavModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSliderModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSlideToggleModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSnackBarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatSortModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatTableModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatTabsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatToolbarModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatTooltipModule"], _angular_material__WEBPACK_IMPORTED_MODULE_8__["MatTreeModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["ScrollingModule"]]
    })], MaterialModule);
    /***/
  },
  ...
  function srcAppComponentsNotificationNotificationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationComponent = /*#__PURE__*/function () {
      function NotificationComponent(store, notificationService) {
      ...
      _createClass(NotificationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.notificationSubscription = this.notificationService.onNotify().subscribe(function (notification) {
            if (!notification || !notification.message) {
              _this2.notification = null;
            }
  ...
  /***/
  function srcAppModelsNotificationModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Notification = function Notification(init) {
  ...
  /***/
  function srcAppModelsOmdbModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppServicesNotificationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_notification_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var NotificationService = /*#__PURE__*/function () {
      ...
      _createClass(NotificationService, [{
        ...
        value: function success(message) {
          this.notify(new _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["Notification"]({
            type: _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["NotificationType"].Success,
            message: message
          }));
        }
      }, {
        ...
        value: function info(message) {
          this.notify(new _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["Notification"]({
            type: _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["NotificationType"].Info,
            message: message
          }));
        }
      }, {
        ...
        value: function warning(message) {
          this.notify(new _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["Notification"]({
            type: _models_notification_model__WEBPACK_IMPORTED_MODULE_2__["NotificationType"].Warning,
            message: message
          }));
        }
      }, {
  ...
  /***/
  function srcAppServicesOmdbServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _models_omdb_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../models/omdb.model */
    "./src/app/models/omdb.model.ts");
    ...
    var OmdbService = /*#__PURE__*/function () {
      ...
      _createClass(OmdbService, [{
        key: "searchForTitle",
        value: function searchForTitle(searchTerm) {
          ...
          params = params.append("page", "".concat(page));
        ...
        key: "searchByIds",
        value: function searchByIds(ids) {
          var _this3 = this;

          return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(ids.map(function (id) {
            return _this3.searchById(id);
          }));
        }
      }]);
    ...
    OmdbService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    OmdbService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()], OmdbService);
    /***/
  },
  ...
  function srcAppStateAppActionsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "searchForMovies", function () {
      return searchForMovies;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "fetchMoviesSuccess", function () {
      return fetchMoviesSuccess;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "populateNominations", function () {
      return populateNominations;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "populateNominationsSuccess", function () {
      return populateNominationsSuccess;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectMovie", function () {
      return selectMovie;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "unselectMovie", function () {
      return unselectMovie;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "enterSearchTerm", function () {
      return enterSearchTerm;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "clearSearch", function () {
      return clearSearch;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "goToPage", function () {
      return goToPage;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "checkNominationStatus", function () {
      return checkNominationStatus;
    });
    /* harmony import */
    ...
    var searchForMovies = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Search for Movies", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var fetchMoviesSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Fetch Movies Success", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var populateNominations = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Populate Nominations", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var populateNominationsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Populate Nominations Success", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var selectMovie = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Select Movie", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var unselectMovie = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Unselect Movie", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var enterSearchTerm = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Enter Search Term", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var clearSearch = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Clear Search");
    var goToPage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Go to Page", Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
    var checkNominationStatus = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])("[App] Check Nomination Status");
    /***/
  },
  ...
  function srcAppStateAppEffectsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_omdb_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../services/omdb.service */
    "./src/app/services/omdb.service.ts");
    /* harmony import */


    var _app_selector__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./app.selector */
    "./src/app/state/app.selector.ts");
    /* harmony import */
    ...
    var _components_helpers_uri_helper__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../components/helpers/uri.helper */
    "./src/app/components/helpers/uri.helper.ts");

    var AppEffects = function AppEffects(store, router, activatedRoute, actions$, omdbService, notificationService, location) {
      var _this4 = this;
      ...
      this.enterSearchTerm$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["searchForMovies"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
        return [_app_actions__WEBPACK_IMPORTED_MODULE_7__["enterSearchTerm"]({
          searchTerm: action.searchValue
        })];
      }));
      this.fetchMovies$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["searchForMovies"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
        return _this4.omdbService.searchForTitle(action.searchValue).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (searchResponse) {
          return _app_actions__WEBPACK_IMPORTED_MODULE_7__["fetchMoviesSuccess"]({
            searchResponse: searchResponse,
            resetPage: true
          });
        }));
      }));
      this.fetchMoviesOnPageChange$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["goToPage"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(this.store.select(function (state) {
        return Object(_app_selector__WEBPACK_IMPORTED_MODULE_9__["selectSearchTerm"])(state);
      }), this.store.select(function (state) {
        return Object(_app_selector__WEBPACK_IMPORTED_MODULE_9__["selectPage"])(state);
        ...
        return _this4.omdbService.searchForTitle(searchTerm, page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (searchResponse) {
          return _app_actions__WEBPACK_IMPORTED_MODULE_7__["fetchMoviesSuccess"]({
            searchResponse: searchResponse
          });
        }));
      }));
      this.fetchMoviesByIds$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["populateNominations"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (action) {
        return _this4.omdbService.searchByIds(action.movieIds).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (movies) {
          return _app_actions__WEBPACK_IMPORTED_MODULE_7__["populateNominationsSuccess"]({
            movies: movies
          });
        }));
      }));
      this.checkNominationStatus$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["selectMovie"], _app_actions__WEBPACK_IMPORTED_MODULE_7__["unselectMovie"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(this.store.select(function (state) {
        return Object(_app_selector__WEBPACK_IMPORTED_MODULE_9__["selectNominatedMovies"])(state);
      ...
      this.sendNotification$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["checkNominationStatus"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(this.store.select(function (state) {
        return Object(_app_selector__WEBPACK_IMPORTED_MODULE_9__["selectNominatedMovies"])(state);
      })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            _ = _ref4[0],
            nominatedMovies = _ref4[1];

        if (nominatedMovies.length === 5) {
          _this4.notificationService.success("You have nominated five movies!");
        } else {
          _this4.notificationService.clear();
        }
      ...
      this.changeUriParams$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_7__["selectMovie"], _app_actions__WEBPACK_IMPORTED_MODULE_7__["unselectMovie"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(this.store.select(function (state) {
        return Object(_app_selector__WEBPACK_IMPORTED_MODULE_9__["selectNominatedMovies"])(state);
      })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 2),
            _ = _ref6[0],
            nominatedMovies = _ref6[1];

        if (nominatedMovies.length === 0) {
          _this4.location.go("");
        } else {
          var nominations = _components_helpers_uri_helper__WEBPACK_IMPORTED_MODULE_12__["UriHelper"].generateParamsFromIds(nominatedMovies.map(function (movie) {
            return movie.imdbID;
          }));

          var uri = _this4.router.createUrlTree([], {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "enterSearchTerm$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "fetchMovies$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "fetchMoviesOnPageChange$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "fetchMoviesByIds$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "checkNominationStatus$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "sendNotification$", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["Effect"])()], AppEffects.prototype, "changeUriParams$", void 0);
  ...
  function srcAppStateAppReducerTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngrx_store_localstorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ngrx-store-localstorage */
    "./node_modules/ngrx-store-localstorage/fesm2015/ngrx-store-localstorage.js");
    /* harmony import */


    var _app_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./app.actions */
    "./src/app/state/app.actions.ts");

    var adapter = Object(_ngrx_entity__WEBPACK_IMPORTED_MODULE_1__["createEntityAdapter"])({
      selectId: function selectId(movie) {
        return movie.imdbID;
      },
      sortComparer: false
    });
    ...
    function appReducer(state, action) {
      return Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["fetchMoviesSuccess"], function (state, _ref7) {
        var searchResponse = _ref7.searchResponse,
            resetPage = _ref7.resetPage;
        var page = resetPage ? 1 : state.page;
      ...
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["populateNominationsSuccess"], function (state, _ref8) {
        var movies = _ref8.movies;
        ...
        return state;
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["selectMovie"], function (state, _ref9) {
        var movie = _ref9.movie;
        return Object.assign({}, state, {
          nominatedMovies: [].concat(_toConsumableArray(state.nominatedMovies), [movie])
        });
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["unselectMovie"], function (state, _ref10) {
        var movieId = _ref10.movieId;
        return Object.assign({}, state, {
          nominatedMovies: state.nominatedMovies.filter(function (movie) {
            return movie.imdbID !== movieId;
          })
        });
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["enterSearchTerm"], function (state, _ref11) {
        var searchTerm = _ref11.searchTerm;
        return Object.assign({}, state, {
          searchTerm: searchTerm
        });
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["clearSearch"], function (state) {
        return Object.assign({}, state, {
          searchTerm: null,
          searchError: "",
          page: 1,
      ...
      }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_4__["goToPage"], function (state, _ref12) {
  ...
  /***/
  function srcAppStateAppSelectorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "selectMovies", function () {
      return selectMovies;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectNominatedMovies", function () {
      return selectNominatedMovies;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectNumOfResults", function () {
      return selectNumOfResults;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "selectSearchTerm", function () {
      return selectSearchTerm;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectSearchError", function () {
      return selectSearchError;
    });
    /* harmony import */
    ...
    var selectMovies = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
      return state.movies;
    });
    var selectNominatedMovies = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
      return state.nominatedMovies;
    });
    var selectNumOfResults = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
      return state.numOfResults;
    });
    var selectPage = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
      return state.page;
    });
    var selectSearchTerm = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
      return state.searchTerm;
    });
    var selectSearchError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectAppState, function (state) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/fnx/GitRepos/fnx-movie-dashboard/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
//# sourceMappingURL=main-es5.d330520c49bb73b0a7a2.js.map